...
switch (global.iso_projection) {
    ...
    //south east
    case 1: 
        return -(arg_isoy+arg_z)/global.iso_factor+global.iso_height/2+arg_isox;
    //south west
    case 2: 
        return -(arg_isoy+arg_z)/global.iso_factor+global.iso_height-arg_isox+global.iso_width/2;
    //north west
    case 3:
